...
class SpecialitySDJpaServiceTest {
    ...
    void deleteByIdThrows() {
        //given
        willThrow(new RuntimeException("boom")).given(specialtyRepository).deleteById(anyLong());
...
//        lenient().when(specialtyRepository.save(argThat(arg -> arg.getDescription().equals(MATCH_ME)))).thenReturn(savedSpeciality);
...
//        assertNull(returnedSpeciality);
    ...
    void testSaveLambdaNoMatch() {
        ...
        lenient().when(specialtyRepository.save(
                argThat(arg -> arg.getDescription().equals(MATCH_ME)))).thenReturn(savedSpeciality);
